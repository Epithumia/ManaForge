            ...
            <dl>
              ...
              <div class="bg-white dark:bg-night-700 px-4 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd class="mt-1 text-xs md:text-sm text-gray-900 sm:mt-0 sm:col-span-2 dark:text-night-100">
                  <span class="inline-block" v-if="debug_step"
                         :class="debug_step ? itemForged.highlight_prehidden:null">
                    &gt;&gt;{{ itemForged.prehidden.text(lang) }}&lt;&lt;
                  </span><br v-if="debug_step">
                  (<span class="inline-block" :class="debug_step ? itemForged.highlight_hidden:null">
                  {{ itemForged.hidden.text(lang) }}
                  </span>)<br>
                  <span class="inline-block" :class="debug_step ? itemForged.highlight_first:null">
                    {{ itemForged.first.text(lang) }}
                  </span><br>
                  <span class="inline-block" :class="debug_step ? itemForged.highlight_second:null">
                    {{ itemForged.second.text(lang) }}
                  </span><br>
                  <span class="inline-block" :class="debug_step ? itemForged.highlight_third:null">
              ...
              <div class="bg-gray-50 dark:bg-night-500 px-4 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd class="mt-1 text-xs md:text-sm text-gray-900 sm:mt-0 sm:col-span-2 dark:text-night-100"
                    ...
                    v-if="selected_object.value<=11">
                  {{ lang === 'classic' ? 'Plunge Attack' : 'Master Move' }} 1:
                  <span class="inline-block" :class="debug_step ? itemForged.highlight_plunge1:null">
                    {{ itemForged.getPlunge1().text(lang) }}
                  </span><br>
                  {{ lang === 'classic' ? 'Plunge Attack' : 'Master Move' }} 2:
                  <span class="inline-block" :class="debug_step ? itemForged.highlight_plunge2:null">
                    {{ itemForged.getPlunge2().text(lang) }}
                  </span><br>
                  {{ lang === 'classic' ? 'Plunge Attack' : 'Master Move' }} 3:
                  <span class="inline-block" :class="debug_step ? itemForged.highlight_plunge3:null">
                ...
                <dd class="mt-1 text-xs md:text-sm text-gray-900 sm:mt-0 sm:col-span-2 dark:text-night-100" v-else>
                  Special:
                  <span class="inline-block" :class="debug_step ? itemForged.highlight_special:null">
